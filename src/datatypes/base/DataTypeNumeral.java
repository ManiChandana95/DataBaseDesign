...
public abstract class DataTypeNumeral<T> extends DT<T>{
    ...
    protected DataTypeNumeral(int valueSerialCode, int nullSerialCode, int size) {
    ...
    public abstract boolean compare(DataTypeNumeral<T> object2, short condition);
}
