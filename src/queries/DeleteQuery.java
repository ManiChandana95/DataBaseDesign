...
public class DeleteQuery implements IQuery {
    ...
    public DeleteQuery(String databaseName, String tableName, Conditn condition){
        this.databaseName = databaseName;
        this.tableName = tableName;
        this.condition = condition;
    }

    public DeleteQuery(String databaseName, String tableName, Conditn condition, boolean isInternal){
        this.databaseName = databaseName;
        this.tableName = tableName;
        this.condition = condition;
    ...
    public Results ExecuteQuery() {
        ...
        Results result = new Results(rowCount, this.isInternal);
        return result;
    }
